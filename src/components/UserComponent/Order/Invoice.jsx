    ...
    >
      ...
      >
        <div style={{ display: "flex", alignItems: "center", gap: "16px" }}>
          ...
          >
          <img 
            src="/ReadHaven logo with a dark brown and white theme, simple and elegant, including book elements and white text (2).png" 
            alt="ReadHaven Logo" 
            style={{ width: "100%", height: "100%", objectFit: "contain" , borderRadius:"10px" }}
         />
          </div>
          <div>
            <h1 style={{ margin: 0, fontSize: "24px", fontWeight: 700 }}>ReadHaven</h1>
          </div>
        </div>
        ...
        >
          ...
          <div>
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: "8px" }}>
              ...
              <div style={{ display: "flex", justifyContent: "space-between" }}>
                <span style={{ color: "#666", fontSize: "14px" }}>Payment Status:</span>
                <span style={{ fontSize: "14px" }}>{orderDetails.paymentStatus}</span>
              </div>
            </div>
          </div>
