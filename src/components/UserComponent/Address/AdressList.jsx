...
import { PlusCircle, Home, Trash2, MapPin, AccessibilityIcon } from "lucide-react";
...
import ConfirmationModal from "@/components/AdminComponent/Modal/ConfirmationModal";
...
const AddressList = () => {
  ...
  const handleDelete = async () => {
    try {
      const response = await deleteAddress(addressIdToDelete);
