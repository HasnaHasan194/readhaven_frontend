...
import Sidebar from "../Size/Sidebar.jsx";
import { editUser, getUsers } from "../../../api/Admin/customerApi";
import ConfirmSwitch from "../Modal/ConfirmSwitch.jsx";
...
const CustomerDetails = () => {
    ...
    const toggleBlockStatus = async (id) => {
        try {
            ...
            await editUser(id); //  it is the api call to block or unblock the user
